...
windows.title("Anil Homework.py")
windows.geometry("1700x1000")

windows["background"]="lightcyan"

labell_g=(Label(windows,text="Welcome to the Anil homework TCA program",
             fg="blue",bg="yellow",font=16)).place(x=1,y=1)
#labell_g.grid(row=0,column=0)

windows.iconbitmap('C:\\Users\\MRC\\Pictures\\pictures')
e=Entry(windows,width=35,borderwidth=6)
e.place(x=1,y=28)
e.insert(90,"Anil you can search programs here")
def online():
...
#################################################################################################################
                                          ...
                                          #this the continues of main page(windows)
def myClick1():
